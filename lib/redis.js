...
const { logSetGetTournamentsCommand } = require('./loggetsettournaments');
...
//   const item = originalShift.call(this);
//   if (item && item.command) logSetGetTournamentsCommand('SHIFT', item.command);
//   return item;
// }
//
// const originalPush = Deque.prototype.push;
